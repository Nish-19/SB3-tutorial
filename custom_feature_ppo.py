...
def parse_arguments():
    ...
    parser.add_argument('--num_test_students', type=int, default=5, help='Number of test students')
    parser.add_argument('--CONSIDER_TEST_CASES', type=int, default=15, help='Number of test cases to consider')
    parser.add_argument('--MAX_EPISODES', type=int, default=5, help='Maximum number of episodes')
